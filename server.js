  ...
  if (players.length != 0) {
    for (var i = 0; i < players.length; i++) {
      ...
      for (var j = 0; j < players.length; j++) {
        ...
        for (var k = 0; k < players[j].blobs.length; k++) {
          for (var l = 0; l < players[i].blobs.length; l++) {
            var killer = calculatedis(players[i].blobs[l], players[j].blobs[k]);
